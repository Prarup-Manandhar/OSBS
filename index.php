...
<html>
<head>
<title>Online Service Booking System||Home Page</title>
	 ...
	 <div class="container">  
		  <div class="slider">
			...
			<ul class="rslides" id="slider">
			  <li><img src="images/bike.jpg" alt="">
				<div class="caption">
					<h1>Image1</h1>
					<p></p>
				</div>
			  </li>
			  <li><img src="images/fix.jpg" alt="">
				<div class="caption">
					<h1>Image2</h1>	  
			...
			<ul id="slider3-pager">
			  <li><a href="#"><img src="images/bike.jpg" alt=""></a></li>
			  <li><a href="#"><img src="images/fix.jpg" alt=""></a></li>
