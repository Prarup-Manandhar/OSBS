				 ...
				 <div class="col-md-6 contact-left">
					 ...
					 <form method="post">
						 ...
						 <ul>
							 ...
							 <li class="text-info">Service Date: </li>
							 <li><input type="date" class="form-control" name="edate" required="true"></li>
						 </ul>					 
						 <ul>
							 <li class="text-info">Service Starting Time:</li>
						...
						<!--  <ul>
						 ...
						 <ul>
							 <li class="text-info">Type of Service:</li>
...
<option value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
 <?php } ?>
						 ...
						 <ul>
							 <li class="text-info">Additional detail:</li>
							 <li><textarea type="text" class="form-control" name="addinfo" required="false"></textarea></li>
						 </ul>					
