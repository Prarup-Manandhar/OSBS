...
<html>
<head>
<title>Online Service Booking System || About Us</title>
...
{               ?>
		 ...
		 <div class="latest">
			 <h3>LATEST PHOTOS</h3>		
			 <div class="pic start">
				 <a class="fancybox" href="images/bike.jpg" data-fancybox-group="gallery" title="Bike servicing"><img src="images/bike.jpg" class="img-style row6" alt=""><span> </span></a>	
				 <h4><a href="event.html">Royal Enfield</a></h4>
				 <p></p>
			 </div>
			 <div class="pic">
				 <a class="fancybox" href="images/fix.jpg" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet"><img src="images/fix.jpg" class="img-style row6" alt=""><span> </span></a>	
				 <h4><a href="event.html">Fix</a></h4>
				 <p></p>
			 </div>
			 <!-- <div class="pic">
